...
> **筆者の実感**：この7つを自分で試したなかで、いちばん効いたのが、じつはこの「ホーム画面から消す」でした。理由はシンプルで、**そもそも目に入る機会がないと、「開こう」という発想自体が浮かばない**からです。我慢して起動を止めるのではなく、起動しようと思うきっかけを消してしまう。これがいちばんラクで、結局いちばん続きました。
